...
conducting sheet, a dielectric material, a magnetic material, or a lumped
...
A *property* always has one or more geometrical shapes assigned to it,
known as *primitives*. Together, they form physical and non-physical
objects in the CSXCAD model.
In principle, any primitive can be assigned to any property. For example,
an excitation source is added to the model by creating a property
via :func:`AddExcitation`, and assigning a Box primitive to it via
:func:`AddBox`.

.. important::

   To create a meaningful object, remember to always assign at least one
   :ref:`concept_primitives` (such as a Box) to every property.

Metal
------

A metal is modeled as a Perfect Electric Conductor (PEC) with infinite
conductivity.
...
.. tabs::
   ...
   .. code-tab:: python
      ...
      # assign primitives via metal.AddBox(), metal.AddCylinder(), etc.
...
.. tabs::
   ...
   .. code-tab:: python
      ...
      # assign primitives via sheet.AddBox(), sheet.AddCylinder(), etc.
...
.. tabs::
   ...
   .. code-tab:: python
      ...
      # assign primitives via plexiglass.AddBox(), plexiglass.AddCylinder(), etc.
...
.. tabs::
   ...
   .. code-tab:: python
      ...
      # assign primitives via yso.AddBox(), yso.AddCylinder(), etc.
...
:math:`\sigma \to \infty`, which allows cutting a symmetrical
...
.. tabs::
   ...
   .. code-tab:: python
      ...
      # assign primitives via capacitor.AddBox(), capacitor.AddCylinder(), etc.
