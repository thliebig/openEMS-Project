...
Lumped elements are ideal throughout regions occupied by all assigned primitives.
However, the intermediate connections between a lumped element and the external
...
capacitor are not correctly modeled, leading to underestimation of parasitic
...
.. figure:: images/smd_cap_2.png
   ...
   create a solid box between the terminals, assigned to a dummy material
...
inductance originates primarily from its mounting height, not its internal
