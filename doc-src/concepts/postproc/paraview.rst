...
always has strong fields and currents, so as long as ParaView's
...
**Logarithmic color scale.** For good visualization, an alternative
...
55 and enabling logarithmic color map allow us to obtain a
