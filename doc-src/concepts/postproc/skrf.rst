...
DUT is resistive, capacitive, or inductive. To do so in ``scikit-rf``,
...
As we can see from the chart, the input impedance of the DUT is inductive.
...
of 70 Ω one nanosecond later (the impulse excitation TDR plot is also
