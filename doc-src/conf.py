...
project = 'openEMS'
copyright = '2023-2026, Thorsten Liebig'
...
exclude_patterns = [
    '_build',
    # Standalone sub-project roots and their pages, superseded by the unified doc structure
    'python/CSXCAD/index.rst',
    'python/CSXCAD/about.rst',
    'python/CSXCAD/install.rst',
    'python/openEMS/index.rst',
    # Autogenerated Octave pages not yet wired into the toctree
    'octave/autogenerated/CSXCAD/SetExcitationWeightFile.md',
    'octave/autogenerated/CSXCAD/WriteCSX.md',
    'octave/autogenerated/README.md',
    'octave/autogenerated/openEMS/CalcSAR.md',
    'octave/autogenerated/openEMS/CleanupSimPath.md',
    'octave/autogenerated/openEMS/h5writemode.md',
    'concepts/image-source/README.md',
]
